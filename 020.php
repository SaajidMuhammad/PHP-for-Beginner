    ...
    <body  class="container" style="background-color:#C0C0C0;">
       <nav class="navbar navbar-expand-sm bg-dark">
		...
		<div id="content" class="bg-light" style="height:1000px;">
			...
			20. Write separate functions for  +,-,* and /  of  two numbers and return values</h4></div>
...
echo "Result for $num1+$num2 = ", add($num1,$num2);
echo "Result for $num1-$num2 = ", sub($num1,$num2);
echo "Result for $num1*$num2 = ", mul($num1,$num2);
echo "Result for $num1/$num2 = ", div($num1,$num2);
			...
			<h3 style="background-color:black; height:40px; color:white;"> <p style="margin-left:20px"> Preview : </p> </h3>
				<div id="code_show2" style="margin:30px 30px 30px 140px;">
					...
					<?php 
						...
						echo "Result for $num1 + $num2 = ", add($num1,$num2),"<br>";
						echo "Result for $num1 - $num2 = ", sub($num1,$num2),"<br>";
						echo "Result for $num1 * $num2 = ", mul($num1,$num2),"<br>";
						echo "Result for $num1 / $num2 = ", div($num1,$num2),"<br>";
