    ...
    <body  class="container" style="background-color:#C0C0C0;">
       <nav class="navbar navbar-expand-sm bg-dark">
		...
		<div id="content" class="bg-light" style="height:600px;">
			...
			29. Write a program to keep five students marks of subject (Hint : Associative  array)</h4></div>
			...
			<h3 style="background-color:black; height:40px; color:white;"> <p style="margin-left:20px"> Input Code : </p> </h3>
				<div id="code_input"  style="margin:30px;">
					<pre>
&lt;?php 
$marks = array("saajid" => 95,
		"nawshad" => 91,
		"fasly" => 89,
		"aadhil" => 93,
		"faros" => 90);
				
echo $marks['saajid'] , "&lt;br>";
echo $marks['nawshad'] , "&lt;br>";
echo $marks['fasly'] , "&lt;br>";
echo $marks['aadhil'] , "&lt;br>";
echo $marks['faros'] , "&lt;br>";
