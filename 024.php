    ...
    <body  class="container" style="background-color:#C0C0C0;">
       <nav class="navbar navbar-expand-sm bg-dark">
		...
		<div id="content" class="bg-light" style="height:600px;">
			...
			24. Write a program to calculate area and circumference of circle when radius entered by user. (Define constant variable for pie value)</h4></div>
...
?&gt;
			...
			<h3 style="background-color:black; height:40px; color:white;"> <p style="margin-left:20px"> Preview : </p> </h3>
				<div id="code_show1" style="margin:30px 30px 30px 0px; text-align:center;">
