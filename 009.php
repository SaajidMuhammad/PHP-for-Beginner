    ...
    <body  class="container" style="background-color:#C0C0C0;">
       <nav class="navbar navbar-expand-sm bg-dark">
		...
		<div id="content" class="bg-light" style="height:600px;">
			<div class="list-group-item list-group-item-dark" style="border-radius:0px; height:60px;"><h4 style="font-weight:bold; text-align:center;">09.Write a program to show  discount according to number of books (Number of books =15)</h4></div>
...
if($books<=10 || $books<=20){
	$dis_per = 15;
}
else if($books<20 || $books<=30){
	$dis_per = 20;
}
else if($books>30){
	$dis_per = 30;
}
echo "Discount for $books Books : $dis_per%";
?&gt;
					</pre>
				</div>
