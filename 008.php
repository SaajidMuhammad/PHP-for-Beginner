    ...
    <body  class="container" style="background-color:#C0C0C0;">
       <nav class="navbar navbar-expand-sm bg-dark">
		...
		<div id="content" class="bg-light" style="height:1200px;">
			<div class="list-group-item list-group-item-dark" style="border-radius:0px; height:60px;"><h4 style="font-weight:bold; text-align:center;">8. Write a program to take average marks of three subjects. (Use Switch Case)</h4></div>
